...
DATA_FILE = './data/exp_5_pos.db'
data_x_pos = np.genfromtxt(DATA_FILE, delimiter=' ')
DATA_FILE = './data/exp_1_neg.db'
data_x_neg=  np.genfromtxt(DATA_FILE, delimiter=' ')

data_x_pos,data_x_neg, names = new_pred.pred_creation('./data/exp_5_pos.db','./data/exp_5_neg.db',3,trig_func=False,only_init=True,inequalities=True)
